...
// verify that the function returns the right data for the user 5debd764a7c57c7839d722e9
describe("notification_tests", function () {
  describe("reads data from JSON", function () {
    ...
    describe("reads data from JSON and normalizes it", function () {
      // verify the normalized data has the correct result array
      ...
      // verify the normalized data has the correct users entity
      ...
      // verify the normalized data has the correct messages entity
      ...
      // verify the normalized data has the correct notifications entity
